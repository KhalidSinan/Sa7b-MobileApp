...
abstract class _Initial<T> implements EditProfileState<T> {
...
class __$$ImagePickedImplCopyWithImpl<T, $Res>
    extends _$EditProfileStateCopyWithImpl<T, $Res, _$ImagePickedImpl<T>>
    implements _$$ImagePickedImplCopyWith<T, $Res> {
  __$$ImagePickedImplCopyWithImpl(
    _$ImagePickedImpl<T> _value,
    $Res Function(_$ImagePickedImpl<T>) _then,
  ) : super(_value, _then);
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? imageFile = freezed}) {
    return _then(
      _$ImagePickedImpl<T>(
        freezed == imageFile
            ? _value.imageFile
...
class _$ImagePickedImpl<T> implements ImagePicked<T> {
  const _$ImagePickedImpl(this.imageFile);
  ...
  @override
  String toString() {
    return 'EditProfileState<$T>.imagePicked(imageFile: $imageFile)';
  }
...
abstract class ImagePicked<T> implements EditProfileState<T> {
  const factory ImagePicked(final File? imageFile) = _$ImagePickedImpl<T>;
